...
--               C:/workplace/Vivado/pipelinecpu_origin/pipelinecpu_origin.srcs/sources_1/new/ip/inst_rom/inst_rom_sim_netlist.vhdl
-- Design      : inst_rom
...
architecture STRUCTURE of inst_rom_rom is
  ...
  attribute SOFT_HLUTNM of \spo[23]_INST_0\ : label is "soft_lutpair1";
...
begin
  ...
  spo(24) <= \^spo\(19);
  spo(23 downto 11) <= \^spo\(23 downto 11);
  spo(10) <= \^spo\(7);
  spo(9) <= \^spo\(7);
  spo(8) <= \^spo\(7);
...
\synth_options.dist_mem_inst\: entity work.inst_rom_dist_mem_gen_v8_0_13_synth
     port map (
      a(9 downto 0) => a(9 downto 0),
      spo(26) => \^spo\(31),
      spo(25 downto 21) => \^spo\(29 downto 25),
      spo(20) => \^spo\(19),
      spo(19 downto 16) => \^spo\(23 downto 20),
      spo(15 downto 8) => \^spo\(18 downto 11),
      spo(7 downto 0) => \^spo\(7 downto 0)
    );
end STRUCTURE;
library IEEE;

...
HD_PWD='E:/Xilinx/pipelinecpu/pipelinecpu/pipelinecpu.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log top_pipeline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_pipeline.tcl

...
--               E:/Xilinx/pipelinecpu/pipelinecpu/pipelinecpu.srcs/sources_1/new/ip/inst_rom/inst_rom_sim_netlist.vhdl
-- Design      : inst_rom
...
architecture STRUCTURE of inst_rom_rom is
  ...
  attribute SOFT_HLUTNM of \spo[27]_INST_0\ : label is "soft_lutpair8";
...
\synth_options.dist_mem_inst\: entity work.inst_rom_dist_mem_gen_v8_0_13_synth
     port map (
      a(9 downto 0) => a(9 downto 0),
      spo(17) => \^spo\(31),
      spo(16 downto 13) => \^spo\(29 downto 26),
      spo(12) => \^spo\(20),
      spo(11 downto 8) => \^spo\(24 downto 21),
      spo(7 downto 6) => \^spo\(19 downto 18),
      spo(5) => \^spo\(3),
      spo(4 downto 3) => \^spo\(16 downto 15),
      spo(2) => \^spo\(5),
      spo(1 downto 0) => \^spo\(1 downto 0)
    );
end STRUCTURE;

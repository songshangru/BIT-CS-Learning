...
HD_PWD='E:/Xilinx/pipelinecpu/pipelinecpu/pipelinecpu.runs/impl_5'
cd "$HD_PWD"
...
EAStep vivado -log top_pipeline.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_pipeline.tcl -notrace
